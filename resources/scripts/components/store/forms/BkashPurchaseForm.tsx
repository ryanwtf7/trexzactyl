...
import { submitBkashPayment } from '@/api/store/gateways/bkash';
...
export default function BkashPurchaseForm() {
                    ...
                    <Form css={tw`space-y-4`}>
                        ...
                        <div css={tw`bg-neutral-800 rounded p-4 text-sm`}>
                            <div css={tw`flex items-center mb-2`}>
                                <Icon.Info size={16} css={tw`mr-2 text-pink-400`} />
                        ...
                        <div css={tw`mt-6`}>
                            <Button type={'submit'} disabled={submitting} css={tw`bg-pink-600 hover:bg-pink-700`}>
