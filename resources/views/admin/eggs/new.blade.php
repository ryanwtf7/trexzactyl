                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="pDockerImages" name="docker_images" rows="4"
                                        placeholder="quay.io/Trexzactyl/service"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea data-action="handle-tabs" id="pConfigLogs" name="config_logs"
                                        class="form-control" rows="6">{{ old('config_logs') }}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea data-action="handle-tabs" id="pConfigFiles" name="config_files"
                                        class="form-control" rows="6">{{ old('config_files') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea data-action="handle-tabs" id="pConfigStartup" name="config_startup"
                                        class="form-control" rows="6">{{ old('config_startup') }}</textarea>
