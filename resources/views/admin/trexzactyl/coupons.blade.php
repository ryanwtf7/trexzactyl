...
@include('partials.admin.trexzactyl.nav', ['activeTab' => 'coupons'])
...
@section('content')
    ...
    <form action="{{ route('admin.trexzactyl.coupons') }}" method="POST">
        <div class="row">
            <div class="col-xs-12">
    ...
    <form action="{{ route('admin.trexzactyl.coupons.store') }}" method="POST">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
