...
@section('content')
    ...
    <form action="{{ route('admin.trexzactyl.approvals') }}" method="POST">
        <div class="row">
            <div class="col-xs-12">
                <div class="box
                    @if($enabled == 'true')
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <form id="massdenyform" action="{{ route('admin.trexzactyl.approvals.all', 'deny') }}" method="POST">
                        {!! csrf_field() !!}
                        <button id="denyAllBtn" class="btn btn-danger pull-right">Deny All</button>
                    </form>
                    <form id="massapproveform" action="{{ route('admin.trexzactyl.approvals.all', 'approve') }}" method="POST">
                        {!! csrf_field() !!}
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form id="approveform" action="{{ route('admin.trexzactyl.approvals.approve', $user->id) }}" method="POST">
                                            {!! csrf_field() !!}
                                    ...
                                    <td class="text-center">
                                        <form id="denyform" action="{{ route('admin.trexzactyl.approvals.deny', $user->id) }}" method="POST">
                                            {!! csrf_field() !!}
