# Local Development
Trexzactyl is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Trexzactyl will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Trexzactyl assets building. After that, its as
...
the asset URLs used in Trexzactyl.

#### Development Environment
If you're using the [`Trexzactyl/development`](https://github.com/Trexzactyl/development) environments, which are
